...
KC.mission_launch = {
    ...
    dictateCode: function() {
        ...
        // v3.26.0: Initial 500ms delay before dictation begins
        sequence.push({ type: 'pause', val: 500 });
    ...
    playAudioSequence: function(seq, index) {
        ...
        if(item.type === 'pause') {
            ...
            setTimeout(() => this.playAudioSequence(seq, index + 1), 400);
        }
    },
